...
<!-- Navigation -->
  ...
  <div id="search-container">
    <div class="hvirfill-controls exhibitions clearfix">     
    
      <div class="title-box">
        <h1 class="f-XXL f-2 title" data-bind="t10n: 'exhibitions'"></h1>
      </div>
...
<script src="/<?php echo $module_path; ?>/js/exhibitions.js"></script>
