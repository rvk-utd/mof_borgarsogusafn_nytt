...
(function($) {
    ...
    var EventsModel = function () {
        ...
        searchQuery.any = 'borgarsogusafn.is';
        ...
        var buildQuery = function() {
            ...
            if (typeof searchQuery.occurrence === 'string' && !searchQuery.occurrence.length)
                delete searchQuery.occurrence;
            return searchQuery;
        }
        ...
        this.switchView = function(model, e) {
            searchQuery.occurrence = e.target.value;
            self.runQuery();
        }
